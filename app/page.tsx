        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-col flex-auto gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  , on the case I had before, the image stated fading into a
                  yellow-ish coloe after a couple of weeks. Love it.&quot;
                </p>
              </div>
            ...
            <div className="flex flex-col flex-auto gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot;I usually keep my keys together with my phone in my
                  pocket and that led to some pretty heavy scratch marks on all
                  of my last phone cases This one, besides a arely noticeable
